...
public interface ServerBuildInfo {
    ...
    /**
     * The brand id for BTC-Core (based on AdvancedSlimePaper).
     */
    Key BRAND_BTC_CORE_ID = Key.key("btccore", "btccore");

    /**
     * @deprecated Use {@link #BRAND_BTC_CORE_ID} instead
     */
    @Deprecated
    Key BRAND_ADVANCED_SLIME_PAPER_ID = BRAND_BTC_CORE_ID;
