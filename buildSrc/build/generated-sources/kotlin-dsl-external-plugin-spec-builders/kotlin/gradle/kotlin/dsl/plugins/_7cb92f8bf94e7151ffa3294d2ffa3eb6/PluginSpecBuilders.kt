...
package gradle.kotlin.dsl.plugins._7cb92f8bf94e7151ffa3294d2ffa3eb6
...
/**
 * The `io.papermc` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoPapermcPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.papermc`.
 */
internal
val `IoPluginGroup`.`papermc`: `IoPapermcPluginGroup`
    get() = `IoPapermcPluginGroup`(plugins)


/**
 * The `io.papermc.paperweight` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoPapermcPaperweightPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.papermc.paperweight`.
 */
internal
val `IoPapermcPluginGroup`.`paperweight`: `IoPapermcPaperweightPluginGroup`
    get() = `IoPapermcPaperweightPluginGroup`(plugins)


/**
 * The `io.papermc.paperweight.core` plugin implemented by [io.papermc.paperweight.core.PaperweightCore].
 */
internal
val `IoPapermcPaperweightPluginGroup`.`core`: PluginDependencySpec
    get() = plugins.id("io.papermc.paperweight.core")


/**
 * The `io.papermc.paperweight.paper-checkstyle` plugin implemented by [io.papermc.paperweight.checkstyle.PaperCheckstyle].
 */
internal
val `IoPapermcPaperweightPluginGroup`.`paper-checkstyle`: PluginDependencySpec
    get() = plugins.id("io.papermc.paperweight.paper-checkstyle")


/**
 * The `io.papermc.paperweight.patcher` plugin implemented by [io.papermc.paperweight.patcher.PaperweightPatcher].
 */
internal
val `IoPapermcPaperweightPluginGroup`.`patcher`: PluginDependencySpec
    get() = plugins.id("io.papermc.paperweight.patcher")


/**
 * The `io.papermc.paperweight.source-generator` plugin implemented by [io.papermc.paperweight.PaperweightSourceGeneratorHelper].
 */
internal
val `IoPapermcPaperweightPluginGroup`.`source-generator`: PluginDependencySpec
    get() = plugins.id("io.papermc.paperweight.source-generator")
...
/**
 * The `net.kyori.indra` plugin group.
 */
@org.gradle.api.Generated
internal
class `NetKyoriIndraPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `net.kyori.indra`.
 */
internal
val `NetKyoriPluginGroup`.`indra`: `NetKyoriIndraPluginGroup`
    get() = `NetKyoriIndraPluginGroup`(plugins)


/**
 * The `net.kyori.indra.git` plugin implemented by [net.kyori.indra.git.GitPlugin].
 */
internal
val `NetKyoriIndraPluginGroup`.`git`: PluginDependencySpec
    get() = plugins.id("net.kyori.indra.git")


/**
 * The `net.minecrell` plugin group.
 */
@org.gradle.api.Generated
internal
class `NetMinecrellPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `net.minecrell`.
 */
internal
val `NetPluginGroup`.`minecrell`: `NetMinecrellPluginGroup`
    get() = `NetMinecrellPluginGroup`(plugins)


/**
 * The `net.minecrell.plugin-yml` plugin group.
 */
@org.gradle.api.Generated
internal
class `NetMinecrellPlugin-ymlPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `net.minecrell.plugin-yml`.
 */
internal
val `NetMinecrellPluginGroup`.`plugin-yml`: `NetMinecrellPlugin-ymlPluginGroup`
    get() = `NetMinecrellPlugin-ymlPluginGroup`(plugins)


/**
 * The `net.minecrell.plugin-yml.bukkit` plugin implemented by [net.minecrell.pluginyml.bukkit.BukkitPlugin].
 */
internal
val `NetMinecrellPlugin-ymlPluginGroup`.`bukkit`: PluginDependencySpec
    get() = plugins.id("net.minecrell.plugin-yml.bukkit")


/**
 * The `net.minecrell.plugin-yml.bungee` plugin implemented by [net.minecrell.pluginyml.bungee.BungeePlugin].
 */
internal
val `NetMinecrellPlugin-ymlPluginGroup`.`bungee`: PluginDependencySpec
    get() = plugins.id("net.minecrell.plugin-yml.bungee")


/**
 * The `net.minecrell.plugin-yml.nukkit` plugin implemented by [net.minecrell.pluginyml.nukkit.NukkitPlugin].
 */
internal
val `NetMinecrellPlugin-ymlPluginGroup`.`nukkit`: PluginDependencySpec
    get() = plugins.id("net.minecrell.plugin-yml.nukkit")


/**
 * The `net.minecrell.plugin-yml.paper` plugin implemented by [net.minecrell.pluginyml.paper.PaperPlugin].
 */
internal
val `NetMinecrellPlugin-ymlPluginGroup`.`paper`: PluginDependencySpec
    get() = plugins.id("net.minecrell.plugin-yml.paper")
...
/**
 * The `org.kordamp.gradle.profiles` plugin implemented by [org.kordamp.gradle.plugin.profiles.ProfilesPlugin].
 */
internal
val `OrgKordampGradlePluginGroup`.`profiles`: PluginDependencySpec
    get() = plugins.id("org.kordamp.gradle.profiles")
