...
public interface WorldRegionizer {
    ...
    interface ChunkRegion {
         ...
         *
         * <ul>
         *     <li>{@link #TRANSIENT} â€“ Region is being created or modified and is not yet stable.</li>
         *     <li>{@link #READY} â€“ Region is active, consistent, and ready for ticking.</li>
         *     <li>{@link #TICKING} â€“ Region is currently being ticked on a tick thread.</li>
         *     <li>{@link #DEAD} â€“ Region is destroyed or scheduled for removal.</li>
         * </ul>
         */
        enum State {
            TRANSIENT,
