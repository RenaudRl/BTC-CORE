package dev.btc.core.api.loaders;
...
public interface SlimeSerializationAdapter {
     ...
     * <p>
     * Unlike {@link BTCCoreAPI#readWorld(SlimeLoader, String, boolean, SlimePropertyMap)} this does not
    ...
    /**
     * The current slime format version used by BTCCore.
     *
