...
publishConfiguration {
    ...
    description.set("The official API for BTC-CORE, a high-performance Paper fork.")
}
...
dependencies {
    ...
    apiAndDocs("net.kyori:adventure-nbt")
...
sourceSets {
    main {
        java {
            srcDir(generatedDir)
            srcDir(file("../paper-api-new/src/main/java"))
        }
        resources {
            srcDir(file("../paper-api-new/src/main/resources"))
        }
    }
    test {
        java {
...
tasks.withType<Javadoc>().configureEach {
    ...
    options.overview = "../paper-api-new/src/main/javadoc/overview.html"
    options.use()
    ...
    inputs.dir("../paper-api-new/src/main/javadoc").withPropertyName("javadoc-sourceset")
