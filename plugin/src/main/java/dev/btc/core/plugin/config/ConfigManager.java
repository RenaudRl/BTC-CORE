package dev.btc.core.plugin.config;
...
/**
 * Manages the configuration files for the SlimeWorldManager plugin.
 */
public class ConfigManager {
    ...
    /**
     * Initializes the configuration manager, loading or creating the necessary configuration files.
     *
     * @throws IOException if an error occurs while loading or creating the configuration files.
     */
     ...
     *
     * @return the data sources configuration.
     */
    ...
    /**
     * Gets the worlds configuration.
     *
     * @return the worlds configuration.
     */
