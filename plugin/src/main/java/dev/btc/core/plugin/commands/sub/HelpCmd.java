 ...
 */
public class HelpCmd extends dev.btc.core.plugin.commands.SlimeCommand {
     ...
     * @param cloudCommandManager the Cloud command manager.
     */
    public HelpCmd(dev.btc.core.plugin.commands.CommandManager commandManager, PaperCommandManager<Source> cloudCommandManager) {
