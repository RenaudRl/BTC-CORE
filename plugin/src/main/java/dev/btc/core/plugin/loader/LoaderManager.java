...
public class LoaderManager {
    ...
    public LoaderManager() {
        dev.btc.core.plugin.config.DatasourcesConfig config = dev.btc.core.plugin.config.ConfigManager.getDatasourcesConfig();

        // File loader
        dev.btc.core.plugin.config.DatasourcesConfig.FileConfig fileConfig = config.getFileConfig();
        registerLoader("file", new FileLoader(new File(fileConfig.getPath())));

        // Mysql loader
        dev.btc.core.plugin.config.DatasourcesConfig.MysqlConfig mysqlConfig = config.getMysqlConfig();
        ...
        // MongoDB loader
        dev.btc.core.plugin.config.DatasourcesConfig.MongoDBConfig mongoConfig = config.getMongoDbConfig();
        ...
        dev.btc.core.plugin.config.DatasourcesConfig.RedisConfig redisConfig = config.getRedisConfig();
        ...
        dev.btc.core.plugin.config.DatasourcesConfig.APIConfig apiConfig = config.getApiConfig();
