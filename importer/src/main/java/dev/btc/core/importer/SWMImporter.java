...
/**
 * Utility for importing Anvil worlds into the Slime format.
 */
public class SWMImporter {
    ...
    /**
     * Imports a world from the given directory to the output file.
     *
     * @param worldDir         the directory containing the Anvil world.
     * @param outputFile       the file to save the Slime world to.
     * @param shouldPrintDebug whether to print debug information.
     */
