...
public class SlimeNMSBridgeImpl implements SlimeNMSBridge {
    ...
    public boolean loadOverworldOverride() {
        ...
        instance.getCraftServer().scoreboardManager = new org.bukkit.craftbukkit.scoreboard.CraftScoreboardManager(
    ...
    private PrimaryLevelData createWorldData(SlimeWorld world) {
        ...
        // BTC-CORE start - Apply default game rules from config
        ...
        com.infernalsuite.asp.config.SlimeWorldConfig.getInstance().applyRules(worldName, gameRules);
        // BTC-CORE end
