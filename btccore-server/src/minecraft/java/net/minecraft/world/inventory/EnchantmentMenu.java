        ...
        if (inventory == this.enchantSlots) {
            ...
            if (!item.isEmpty()) { // CraftBukkit - relax condition
                this.access.execute((level, pos) -> {
                    ...
                    org.bukkit.event.enchantment.PrepareItemEnchantEvent event = new org.bukkit.event.enchantment.PrepareItemEnchantEvent(this.player, this.getBukkitView(), this.access.getLocation().getBlock(), (org.bukkit.inventory.ItemStack) (Object) craftItemStack, offers, i1);
