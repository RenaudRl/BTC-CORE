    ...
    public String getChunkDebugData(ChunkPos pos) {
        ...
        if (visibleChunkIfPresent == null) {
            ...
            if (latestStatus != null) {
                string = string + "St: Â§" + latestStatus.getIndex() + latestStatus + "Â§r\n";
            }

            if (latestChunk != null) {
                string = string + "Ch: Â§" + latestChunk.getPersistedStatus().getIndex() + latestChunk.getPersistedStatus() + "Â§r\n";
            }
    ...
    public void move(ServerPlayer player) {
        ...
        if (flag2 || flag != flag1) {
            ...
            if (oldRegionX != newRegionX || oldRegionZ != newRegionZ) {
                new dev.btc.core.event.player.PlayerEnterRegionEvent(player.getBukkitEntity(), oldRegionX, oldRegionZ, newRegionX, newRegionZ).callEvent();
            }
            // ASP end
        }
