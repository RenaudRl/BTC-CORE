...
public abstract class ServerCommonPacketListenerImpl implements ServerCommonPacketListener {
    ...
    public void send(Packet<?> packet, @Nullable ChannelFutureListener sendListener) {
        ...
        if (dev.btc.core.config.BTCCoreConfig.betterHudCullingEnabled && packet instanceof net.minecraft.network.protocol.game.ClientboundSetEntityDataPacket dataPacket) {
            if (this instanceof ServerGamePacketListenerImpl gameListener && this.server.isSameThread()) {
                 ...
                 if (entity instanceof net.minecraft.world.entity.Display && !dev.btc.core.performance.PerformanceManager.shouldSendBetterHud(gameListener.player.getBukkitEntity(), entity.getBukkitEntity().getLocation())) {
                     return;
                 }
            }
        }
