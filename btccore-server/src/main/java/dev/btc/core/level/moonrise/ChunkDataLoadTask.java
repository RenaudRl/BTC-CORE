package dev.btc.core.level.moonrise;
...
public final class ChunkDataLoadTask implements CommonLoadTask {
    ...
    public ChunkDataLoadTask(ChunkLoadTask chunkLoadTask, final ChunkTaskScheduler scheduler, final ServerLevel world, final int chunkX,
        ...
        this.task = this.scheduler.createChunkTask(this.chunkX, this.chunkZ, () -> {
            try {
                SlimeChunk chunk = ((dev.btc.core.level.SlimeLevelInstance) this.world).getSlimeInstance().getChunk(this.chunkX, this.chunkZ);
    ...
    private ChunkAccess runOnMain(final SlimeChunk data) {
        try {
            net.minecraft.world.level.chunk.LevelChunk chunk = ((dev.btc.core.level.SlimeInMemoryWorld) ((dev.btc.core.level.SlimeLevelInstance) this.world).getSlimeInstance()).createChunk(chunkX, chunkZ, data);
            return new net.minecraft.world.level.chunk.ImposterProtoChunk(chunk, false);
        } catch (final Exception e) {
