package dev.btc.core.serialization.slime.reader.impl.v1_9.upgrade;
...
public class v1_18WorldUpgrade implements dev.btc.core.serialization.slime.reader.impl.v1_9.Upgrade {
    ...
    @Override
    public void upgrade(dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeWorld world, SlimeDataConverter converter) {
        for (dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunk chunk : world.chunks.values()) {
            ...
            dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection[] sections = chunk.sections;
            for (int i = 0; i < sections.length; i++) {
                dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection section = sections[i];
                if (section == null) {
                    continue;
                }
            ...
            dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection[] shiftedSections = new dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection[sections.length + 4];
            System.arraycopy(sections, 0, shiftedSections, 4, sections.length);

            chunk.sections = shiftedSections; // Shift all sections up 4


            dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection[] sectionArray = chunk.sections;
            ...
            for (int i = 0; i < sectionArray.length; i++) {
                dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection section = sectionArray[i];
                if (section == null) {
                    sectionArray[i] = new dev.btc.core.serialization.slime.reader.impl.v1_9.v1_9SlimeChunkSection(
                            null,
                            null,
                            null,
                            null,
