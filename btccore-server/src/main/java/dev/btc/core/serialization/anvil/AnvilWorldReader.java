package dev.btc.core.serialization.anvil;
...
public class AnvilWorldReader implements dev.btc.core.serialization.SlimeWorldReader<AnvilImportData> {
    ...
    public SlimeWorld readFromData(AnvilImportData importData) {
        ...
        try {
            ...
            return new dev.btc.core.skeleton.SkeletonSlimeWorld(importData.newName(), importData.loader(), importData.loader() == null,
